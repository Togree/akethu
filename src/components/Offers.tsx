function Offers() {
    const features = [
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="red" className="w-6 h-6 transition-transform duration-300 ease-in-out hover:scale-125">
        ...
        },
        {
            ...
            title: "Sell all types of Trackers",
