...
function Offers() {
  ...
  return (
    ...
    <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8 flex flex-col items-center justify-center">
        <div className="max-w-xl space-y-3 flex flex-col items-center ">
